...
# 📖 Blog Post <a name="about-the-project"></a>

> This is a blog app based on ruby on rails. This app features users, posts, comments, likes.
...
```sh
  cd my-folder
  git clone git@github.com:Katended/blog_app.git
```
